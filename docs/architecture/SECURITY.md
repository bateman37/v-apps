...
- **Contraseñas temporales**: solo se muestran una vez, en el resultado inmediato de la acción que las genera (`/admin/people`, «Personas y accesos»; `/admin/users` redirige ahí desde el hotfix DEV-005); no se guardan para poder volver a mostrarlas.
